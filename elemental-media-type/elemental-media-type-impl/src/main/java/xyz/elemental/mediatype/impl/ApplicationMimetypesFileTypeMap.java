...
public class ApplicationMimetypesFileTypeMap extends MimetypesFileTypeMap {
    ...
    public ApplicationMimetypesFileTypeMap(@Nullable final Path... configDirs) {
        final Vector<MimeTypeFile> dbv = new Vector<>(6);	// usually 6 or fewer databases
        ...
        if (loadAllResourcesMethod != null) {
            loadAllResourcesRefl(loadAllResourcesMethod, dbv, "xyz/elemental/mediatype/" + JAKARTA_MIME_TYPES_FILENAME);
            loadAllResourcesRefl(loadAllResourcesMethod, dbv, "xyz/elemental/mediatype/" + LEGACY_MIME_TYPES_FILENAME);
        }
        ...
        if (loadAllResourcesMethod != null) {
            ...
            loadAllResourcesRefl(loadAllResourcesMethod, dbv, "META-INF/" + JAKARTA_MIME_TYPES_FILENAME);
            loadAllResourcesRefl(loadAllResourcesMethod, dbv, "META-INF/" + LEGACY_MIME_TYPES_FILENAME);
        }
        ...
        if (loadResourceMethod != null) {
            ...
            mf = loadResourceRefl(loadResourceMethod, "/META-INF/jakarta.mimetypes.default");
            mf = loadResourceRefl(loadResourceMethod, "/META-INF/mimetypes.default");
        }
    ...
    private @Nullable MimeTypeFile loadFileRefl(final Method loadFileMethod, final String name) {
        try {
    ...
    private void loadAllResourcesRefl(final Method loadAllResourcesMethod, final Vector v, final String name) {
        try {
    ...
    private @Nullable MimeTypeFile loadResourceRefl(final Method loadResourceMethod, final String name) {
        try {
