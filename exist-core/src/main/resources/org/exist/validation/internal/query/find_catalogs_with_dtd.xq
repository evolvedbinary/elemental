...
declare variable $local:publicId as xs:string+ external;

for $uri in collection($local:collection)//ctlg:catalog/ctlg:public[@publicId = $local:publicId]/@uri
return
    document-uri(root($uri))