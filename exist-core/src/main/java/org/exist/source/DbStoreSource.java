...
public interface DbStoreSource extends Source {

    /**
     * Get the database URI of the document backing this source.
     *
     * @return the URI of the document backing this source.
     */
