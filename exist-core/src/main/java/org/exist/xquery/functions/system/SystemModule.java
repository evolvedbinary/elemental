...
public class SystemModule extends AbstractInternalModule {
    ...
    public static final FunctionDef[] functions = {
            ...
            new FunctionDef(GetElementalHome.FS_GET_ELEMENTAL_HOME, GetElementalHome.class),
            new FunctionDef(GetElementalHome.FS_GET_EXIST_HOME, GetElementalHome.class),
            ...
            new FunctionDef(FunctionAvailable.FS_FUNCTIONAL_AVAILABLE, FunctionAvailable.class),
