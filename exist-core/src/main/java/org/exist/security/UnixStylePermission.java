...
public class UnixStylePermission extends AbstractUnixStylePermission implements Permission {
    ...
    private void setOwnerId(@PermissionRequired(user = IS_DBA | NOT_POSIX_CHOWN_RESTRICTED) final int ownerId) throws PermissionDeniedException {
        this.vector =
    ...
    @PermissionRequired(user = IS_DBA | IS_OWNER)
    private void setGroupId(@PermissionRequired(user = IS_DBA | IS_MEMBER | NOT_POSIX_CHOWN_RESTRICTED) final int groupId) throws PermissionDeniedException {
        /*
    ...
    @PermissionRequired(user = IS_DBA | IS_OWNER)
    @Override
    final public void setMode(final int mode) throws PermissionDeniedException {
        this.vector =
