...
public class XMLTestDescriptor extends AbstractTestDescriptor implements Node<XSuiteExecutionContext> {

    public XMLTestDescriptor(final UniqueId uniqueId, final String displayName, final @Nullable TestSource source) {
