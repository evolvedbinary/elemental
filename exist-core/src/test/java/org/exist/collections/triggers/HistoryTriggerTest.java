...
public class HistoryTriggerTest {
    ...
    void setup(final BrokerPool brokerPool) throws EXistException, PermissionDeniedException, IOException, SAXException, LockException {
        try(final DBBroker broker = brokerPool.get(Optional.of(brokerPool.getSecurityManager().getSystemSubject()));
            ...
            broker.storeDocument(transaction, CollectionConfiguration.DEFAULT_COLLECTION_CONFIG_FILE_URI, new StringInputSource(COLLECTION_CONFIG), xmlMediaType, configCollection);
