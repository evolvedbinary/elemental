...
class Base64BinaryValueTypeTest {
    ...
    @Test
    void verify_invalidBase64_fails() {
    ...
    @Test
    void verify_invalidBase64_fails_2() {
        TestableBase64BinaryValueType base64Type = new TestableBase64BinaryValueType();
        assertThrows(XPathException.class, () ->
    ...
    @Test
    void verify_validBase64_passes() throws XPathException {
        TestableBase64BinaryValueType base64Type = new TestableBase64BinaryValueType();
        base64Type.verifyString("aaabbcd=");
    }

    @Test
    void verify_validBase64_passes_2() throws XPathException {
        TestableBase64BinaryValueType base64Type = new TestableBase64BinaryValueType();
        base64Type.verifyString("dGVzdCBkYXRh");
    }

    @Test
    void verify_validBase64_passes_3() throws XPathException {
        TestableBase64BinaryValueType base64Type = new TestableBase64BinaryValueType();
        base64Type.verifyString("aaa a");
    }

    @Test
    void verify_validBase64_passes_large_string() throws XPathException, IOException, URISyntaxException {
