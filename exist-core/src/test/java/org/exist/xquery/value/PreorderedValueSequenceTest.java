...
public class PreorderedValueSequenceTest {
    ...
    private static PreorderedValueSequence mockPreorderedValueSequence(final int size) throws XPathException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            expect(mockNode.getType()).andReturn(Type.NODE).times(4);
            expect(mockNode.compareTo(anyObject(Object.class))).andReturn(-1).anyTimes();
            expect(mockNode.compareTo(anyObject(mockNode.getClass()))).andReturn(-1).anyTimes();
