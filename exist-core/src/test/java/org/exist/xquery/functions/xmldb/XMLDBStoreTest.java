...
public class XMLDBStoreTest {
    ...
    @Test
    void storeWithoutBomWithoutDecl() throws XMLDBException {
    ...
    @Test
    void storeWithoutBomWithDecl() throws XMLDBException {
    ...
    @Test
    void storeWithUtf8BomWithoutDecl() throws XMLDBException {
    ...
    @Test
    void storeWithUtf8BomWithDecl() throws XMLDBException {
    ...
    @Test
    void storeWithUtf16BEBomWithoutDecl() throws XMLDBException {
    ...
    @Test
    void storeWithUtf16LEBomWithoutDecl() throws XMLDBException {
