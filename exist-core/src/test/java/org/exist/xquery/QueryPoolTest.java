...
public class QueryPoolTest {
    ...
    public void read() throws XMLDBException {
        try (final EXistResource res = (EXistResource) testCollection.getResource("large_list.xml")) {
            assertNotNull(res);
        }
    }
    ...
    public void setUp() throws ClassNotFoundException, IllegalAccessException, InstantiationException, XMLDBException {
        ...
        try (final EXistResource doc = (EXistResource) testCollection.createResource("large_list.xml", XMLResource.RESOURCE_TYPE)) {
