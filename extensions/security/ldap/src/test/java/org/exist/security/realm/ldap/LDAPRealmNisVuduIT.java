...
@AbstractLDAPRealmNisIT.ElementalDbSecurityConfig(fileName = "ldap-example-1-vudu.config.xml")
public class LDAPRealmNisVuduIT extends AbstractLDAPRealmNisIT {

    public LDAPRealmNisVuduIT() {
        super(PrincipalPattern.ABSENT, DefaultUser.PRESENT_VALID_UNQUALIFIED);
    }
}
