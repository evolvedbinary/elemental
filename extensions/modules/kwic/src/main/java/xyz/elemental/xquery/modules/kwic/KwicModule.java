...
public class KwicModule extends AbstractInternalModule {

    public static final String NAMESPACE_URI = "http://ns.elemental.xyz/xquery/kwic";

    public static final String PREFIX = "kwic";
    public static final String RELEASED_IN_VERSION = "Elemental-6.9.0";

    public static final FunctionDef[] FUNCTIONS = functionDefs(
        KwicSummary.class,
        KwicSummary.FS_SUMMARY[0],
        KwicSummary.FS_SUMMARY[1]
    );

    public KwicModule(final Map<String, List<?>> parameters) {
